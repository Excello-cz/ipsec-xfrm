...
ip xfrm policy add dir in src ::/0 dst ::/0 proto ipv6-icmp priority 2147483548
ip xfrm policy add dir in src 0.0.0.0/0 dst 0.0.0.0/0 proto icmp priority 2147483548
ip xfrm policy add dir in src ::/0 dst ::/0 dport 13 priority 2147483548
ip xfrm policy add dir in src ::/0 dst ::/0 sport 13 priority 2147483548
ip xfrm policy add dir in src 0.0.0.0/0 dst 0.0.0.0/0 dport 13 priority 2147483548
ip xfrm policy add dir in src 0.0.0.0/0 dst 0.0.0.0/0 sport 13 priority 2147483548
ip xfrm policy add dir out src ::/0 dst ::/0 proto ipv6-icmp priority 2147483548
ip xfrm policy add dir out src 0.0.0.0/0 dst 0.0.0.0/0 proto icmp priority 2147483548
ip xfrm policy add dir out src ::/0 dst ::/0 dport 13 priority 2147483548
ip xfrm policy add dir out src ::/0 dst ::/0 sport 13 priority 2147483548
ip xfrm policy add dir out src 0.0.0.0/0 dst 0.0.0.0/0 dport 13 priority 2147483548
ip xfrm policy add dir out src 0.0.0.0/0 dst 0.0.0.0/0 sport 13 priority 2147483548
ip xfrm state add src 192.168.0.2 dst 192.168.0.1 proto esp spi 0x00020001 aead rfc4106(gcm(aes)) 0xaabbccddee 96 mode transport extra-flag 0x2
ip xfrm state add src 192.168.0.1 dst 192.168.0.2 proto esp spi 0x00010002 aead rfc4106(gcm(aes)) 0x0011223344 96 mode transport extra-flag 0x2
ip xfrm policy add dir out src 192.168.0.2 dst 192.168.0.1 priority 2147483648 tmpl proto esp mode transport
ip xfrm policy add dir in src 192.168.0.1 dst 192.168.0.2 priority 2147483648 tmpl proto esp mode transport
...
ip xfrm policy add dir in src 0.0.0.0/0 dst 0.0.0.0/0 dport 13 priority 2147483548
ip xfrm policy add dir in src 0.0.0.0/0 dst 0.0.0.0/0 sport 13 priority 2147483548
ip xfrm policy add dir in src ::/0 dst ::/0 dport 14 priority 2147483548
ip xfrm policy add dir in src ::/0 dst ::/0 sport 14 priority 2147483548
ip xfrm policy add dir in src 0.0.0.0/0 dst 0.0.0.0/0 dport 14 priority 2147483548
ip xfrm policy add dir in src 0.0.0.0/0 dst 0.0.0.0/0 sport 14 priority 2147483548
ip xfrm policy add dir out src ::/0 dst ::/0 proto ipv6-icmp priority 2147483548
ip xfrm policy add dir out src 0.0.0.0/0 dst 0.0.0.0/0 proto icmp priority 2147483548
ip xfrm policy add dir out src ::/0 dst ::/0 dport 13 priority 2147483548
ip xfrm policy add dir out src ::/0 dst ::/0 sport 13 priority 2147483548
ip xfrm policy add dir out src 0.0.0.0/0 dst 0.0.0.0/0 dport 13 priority 2147483548
ip xfrm policy add dir out src 0.0.0.0/0 dst 0.0.0.0/0 sport 13 priority 2147483548
ip xfrm policy add dir out src ::/0 dst ::/0 dport 14 priority 2147483548
ip xfrm policy add dir out src ::/0 dst ::/0 sport 14 priority 2147483548
ip xfrm policy add dir out src 0.0.0.0/0 dst 0.0.0.0/0 dport 14 priority 2147483548
ip xfrm policy add dir out src 0.0.0.0/0 dst 0.0.0.0/0 sport 14 priority 2147483548
ip xfrm state add src 192.168.0.2 dst 192.168.0.1 proto esp spi 0x00020001 aead rfc4106(gcm(aes)) 0xaabbccddee 96 mode transport extra-flag 0x2
ip xfrm state add src 192.168.0.1 dst 192.168.0.2 proto esp spi 0x00010002 aead rfc4106(gcm(aes)) 0x0011223344 96 mode transport extra-flag 0x2
ip xfrm policy add dir out src 192.168.0.2 dst 192.168.0.1 priority 2147483648 tmpl proto esp mode transport
ip xfrm policy add dir in src 192.168.0.1 dst 192.168.0.2 priority 2147483648 tmpl proto esp mode transport
